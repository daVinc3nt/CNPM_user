  ...
  export const TabSlider:React.FC<CustomDropdownProps> = ({
    ...
    return (
      <div className="flex gap-5">
        ...
        justify-center overflow-hidden bg-white font-medium 
        text-black">
              <div className="flew-row w-fit text-nowrap relative mx-auto flex h-12 rounded-3xl
                  bg-white  px-2 backdrop-blur-sm">
                <span
                ...
                {allTabs.map((tab) => {
                  ...
                  return (
                    <button
                      ...
                      } my-auto cursor-pointer select-none rounded-full px-2 text-center font-medium text-black `}
