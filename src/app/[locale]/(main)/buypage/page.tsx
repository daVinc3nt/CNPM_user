	...
	return (
        ...
        <section className="h-screen w-screen bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] 
            ...
            <div className="pt-24 flex flex-col gap-5 h-full items-center justify-center w-full">
                <div className="text-center h-fit rounded-full bg-blue-600 px-10 py-2">
                ...
                <div className="flex animate-slide_in_up gap-24 h-[calc(60%)] w-full items-center justify-center">
                    ...
                    bg-blue-500 rounded-lg border border-gray-100 shadow  xl:p-8">
                        ...
                        <div className="flex justify-center items-baseline my-8">
                            <span className="mr-2 text-5xl font-extrabold">500 vnđ</span>
                            <span className="text-white ">/tờ</span>
                        </div>
                        <ul role="list" className="h-1/3 space-y-4 text-left">
                    ...
                    bg-blue-500 rounded-lg border border-gray-100 shadow  xl:p-8  ">
                        ...
                        <div className="flex justify-center items-baseline my-8">
                            <span className="mr-2 text-5xl font-extrabold">1.000 vnđ</span>
                            <span className="text-white ">/tờ</span>
                        </div>
                        <ul role="list" className="h-1/3 space-y-4 text-left">
                            <li className="flex items-center space-x-3">
